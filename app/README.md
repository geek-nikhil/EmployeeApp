...
## AI Usage Disclosure
This project was scaffolded and implemented with the assistance of an AI coding agent. All business logic, security policies, and frontend components were designed by the AI based on the provided requirements.
